...
// ── NGRT (New Group Reading Test) — re-exported from dedicated file ──────────
// Full 30-question tests (3 passages × 10 questions) live in englishNGRT.ts.
// Re-export everything from there so existing imports keep working.
