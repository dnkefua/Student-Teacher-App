    ...
    <div className="space-y-4">
      {formula ? (
        <div className="rounded-md border border-amber-200 bg-amber-50 px-4 py-3">
          ...
          <p
            className="mt-1 text-base font-bold text-amber-900"
        ...
        {visibleSteps.map((step, i) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              {step.working ? (
                <p
                  className="mt-2 inline-block rounded-md border border-slate-200 bg-slate-50 px-4 py-1.5 text-base font-semibold text-slate-900 break-words"
                  style={{ fontFamily: 'Cambria Math, Cambria, Georgia, "Times New Roman", serif' }}
                >
                  {step.working}
                </p>
      ...
      {(showAll || atEnd) && (
        <div className="rounded-md border border-emerald-200 bg-emerald-50 p-4">
          ...
          <p
            className="mt-1 text-lg font-bold text-emerald-900 break-words"
            style={{ fontFamily: 'Cambria Math, Cambria, Georgia, "Times New Roman", serif' }}
          >
            {answer}
          </p>
